...
<body class="w-full max-w-mobile mx-auto overflow-x-hidden bg-white relative">
    ...
    <!-- RSVP Button -->
    <a href="https://byvn.net/ieiV" target="_blank" class="fixed bottom-4 right-4 z-50 px-4 py-2 bg-[#baa58a] rounded-full flex items-center justify-center text-white shadow-lg text-sm font-quicksand">
